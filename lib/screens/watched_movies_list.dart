...
class WatchedMoviesList extends StatelessWidget {
                        ...
                        title: Row(
                            ...
                            children: [
                              Icon(Icons.edit,
                                  color: Color.fromRGBO(211, 12, 27, 1)),
                              SizedBox(width: 10),
                              Text('Editar', style: TextStyle(fontSize: 17, letterSpacing: 2))
                            ]),
                        onTap: () {
                        ...
                        title: Row(
                            ...
                            children: [
                              Icon(Icons.delete,
                                  color: Color.fromRGBO(211, 12, 27, 1)),
                              SizedBox(width: 10),
                              Text('Excluir', style: TextStyle(fontSize: 17, letterSpacing: 2))
                            ]),
                        onTap: () {
